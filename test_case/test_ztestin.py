...
class Ztestin(unittest.TestCase):
    ...
    def test_03_rongyu(self):
        self.driver.find_element_by_xpath(".//*[@id='qqww']/div[1]/div/ul/li[2]/a").click()
        self.driver.find_element_by_xpath(".//*[@id='qqww']/div[3]/div/div[2]/div/p").click()
        # driver.find_element_by_xpath(".//div[@class='testin-select-hidden']/ul/li[2]").click()
